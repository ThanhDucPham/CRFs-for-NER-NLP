...
X_train = [sent2feature(s) for s in getdataset(train_sents, 9000, randomList)]
y_train = [sent2labels(s) for s in getdataset(train_sents, 9000, randomList)]
X_test = [sent2feature(s) for s in getdataset(train_sents, -1000, randomList)]
y_test = [sent2labels(s) for s in getdataset(train_sents, -1000, randomList)]
...
print('1', example_[0])
example_ = [('xin','O'),('cấp','O'),('Giấy','O'),('Chứng_Nhận','O'),('tại','O'),('UBND','B-ORG'),('thành_phố','I-ORG')]
